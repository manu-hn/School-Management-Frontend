...
// Define the custom tooltip component using Tailwind CSS
            ...
            <div className="bg-white rounded-lg p-3 shadow-lg">
                {dataKey === "attendancePercentage" ? (
                    <>
                        ...
                        <p className="text-gray-800 font-bold">Attended: ({attendedClasses}/{totalClasses})</p>
                        <p className="text-gray-800 font-bold">{attendancePercentage}%</p>
                    </>
                ) : (
                    <>
                        <h2 className="text-xl font-bold text-black">{subName.subName}</h2>
                        <p className="text-gray-800 font-bold">Marks: {marksObtained}</p>
                    </>
                )}
            </div>
        );
