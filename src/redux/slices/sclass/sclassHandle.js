...
export const getClassStudents = (id) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${import.meta.env.VITE_REACT_APP_BASE_URL}/Sclass/Students/${id}`);
        if (result.data.message) {
            dispatch(getFailedTwo(result.data.message));
        } else {
...
// Similar modifications for other action creators...
...
export const getClassDetails = (id, address) => async (dispatch) => {
    ...
    try {
        ...
        console.log("Hello Class", result.data.data)
        if (result.data) {
...
export const getTeacherFreeClassSubjects = (id) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${import.meta.env.VITE_REACT_APP_BASE_URL}/FreeSubjectList/${id}`);
        console.log("Get Teacher Data", result.data)
